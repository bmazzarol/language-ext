...
namespace LanguageExt
{
    public static partial class Prelude
    {
        ...
        public static Aff<RT, S> fold<RT, S, A>(Schedule<RT, A> schedule, Aff<RT, A> ma, S state, Func<S, A, S> fold)
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> fold<RT, S, A>(Schedule<A> schedule, Aff<RT, A> ma, S state, Func<S, A, S> fold)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.Fold(ma, schedule, state, fold);
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Aff<S> fold<S, A>(Schedule<A> schedule, Aff<A> ma, S state, Func<S, A, S> fold)
        ...
        public static Aff<RT, S> foldWhile<RT, S, A>(
            Schedule<RT, A> schedule, Aff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct, HasCancel<RT>
        ...
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> foldWhile<RT, S, A>(
            Schedule<A> schedule, Aff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct, HasCancel<RT> =>
            ScheduleAff<RT, A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> foldWhile<RT, S, A>(
            Schedule schedule, Aff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        public static Aff<S> foldWhile<S, A>(
            Schedule<A> schedule, Aff<A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
        ...
        /// <returns>The result of the fold operation</returns>
        public static Aff<S> foldWhile<S, A>(
            Schedule schedule, Aff<A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
            => ScheduleAff<A>.FoldWhile(ma, schedule, state, fold, pred);
