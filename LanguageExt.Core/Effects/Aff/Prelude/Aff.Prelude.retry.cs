...
namespace LanguageExt
{
    public static partial class Prelude
    {
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retry<RT, A>(Schedule<RT, A> schedule, Aff<RT, A> ma) where RT : struct, HasCancel<RT>
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retry<RT, A>(Schedule<A> schedule, Aff<RT, A> ma) where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.Retry(ma, schedule);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<A> retry<A>(Schedule<A> schedule, Aff<A> ma)
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retryWhile<RT, A>(Aff<RT, A> ma, Func<Error, bool> predicate)
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retryWhile<RT, A>(Schedule<RT, A> schedule, Aff<RT, A> ma, Func<Error, bool> predicate)
            where RT : struct, HasCancel<RT>
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retryWhile<RT, A>(Schedule<A> schedule, Aff<RT, A> ma, Func<Error, bool> predicate)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.RetryWhile(ma, schedule, predicate);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retryWhile<RT, A>(Schedule schedule, Aff<RT, A> ma, Func<Error, bool> predicate)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.RetryWhile(ma, schedule, predicate);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<A> retryWhile<A>(Schedule<A> schedule, Aff<A> ma, Func<Error, bool> predicate)
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retryUntil<RT, A>(Aff<RT, A> ma, Func<Error, bool> predicate)
            where RT : struct, HasCancel<RT>
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retryUntil<RT, A>(Schedule<RT, A> schedule, Aff<RT, A> ma, Func<Error, bool> predicate)
            where RT : struct, HasCancel<RT>
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retryUntil<RT, A>(Schedule<A> schedule, Aff<RT, A> ma, Func<Error, bool> predicate)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.RetryUntil(ma, schedule, predicate);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<RT, A> retryUntil<RT, A>(Schedule schedule, Aff<RT, A> ma, Func<Error, bool> predicate)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.RetryUntil(ma, schedule, predicate);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Aff<A> retryUntil<A>(Schedule<A> schedule, Aff<A> ma, Func<Error, bool> predicate)
