...
namespace LanguageExt
{
    public static partial class AffExtensions
    {
        ...
        public static Aff<RT, S> Fold<RT, S, A>(this Aff<RT, A> ma, Schedule<RT, A> schedule, S state,
            Func<S, A, S> fold)
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> Fold<RT, S, A>(this Aff<RT, A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.Fold(ma, schedule, state, fold);
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Aff<S> Fold<S, A>(this Aff<A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold)
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> FoldWhile<RT, S, A>(
            this Aff<RT, A> ma, Schedule<RT, A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct, HasCancel<RT>
        ...
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> FoldWhile<RT, S, A>(
            this Aff<RT, A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> FoldWhile<RT, S, A>(
            this Aff<RT, A> ma, Schedule schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct, HasCancel<RT>
            => ScheduleAff<RT, A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> FoldWhile<RT, S, A>(
            this Aff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct, HasCancel<RT>
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Aff<S> FoldWhile<S, A>(
            this Aff<A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
        ...
        /// <returns>The result of the fold operation</returns>
        public static Aff<S> FoldWhile<S, A>(
            this Aff<A> ma, Schedule schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
            => ScheduleAff<A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Aff<RT, S> FoldUntil<RT, S, A>(
            this Aff<RT, A> ma, Schedule<RT, A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct, HasCancel<RT>
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Aff<S> FoldUntil<S, A>(
            this Aff<A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
