...
namespace LanguageExt
{
    public static partial class EffExtensions
    {
        ...
        public static Eff<RT, S> Fold<RT, S, A>(
            this Eff<RT, A> ma, Schedule<RT, A> schedule, S state, Func<S, A, S> fold)
            where RT : struct
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> Fold<RT, S, A>(this Eff<RT, A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold)
            where RT : struct
            => ScheduleEff<RT, A>.Fold(ma, schedule, state, fold);
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Eff<S> Fold<S, A>(this Eff<A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold)
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> FoldWhile<RT, S, A>(
            this Eff<RT, A> ma, Schedule<RT, A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct
        ...
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> FoldWhile<RT, S, A>(
            this Eff<RT, A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred) where RT : struct
            => ScheduleEff<RT, A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> FoldWhile<RT, S, A>(
            this Eff<RT, A> ma, Schedule schedule, S state, Func<S, A, S> fold, Func<A, bool> pred) where RT : struct
            => ScheduleEff<RT, A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> FoldWhile<RT, S, A>(
            this Eff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred) where RT : struct
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Eff<S> FoldWhile<S, A>(
            this Eff<A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
        ...
        /// <returns>The result of the fold operation</returns>
        public static Eff<S> FoldWhile<S, A>(
            this Eff<A> ma, Schedule schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
            => ScheduleEff<A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> FoldUntil<RT, S, A>(
            this Eff<RT, A> ma, Schedule<RT, A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Eff<S> FoldUntil<S, A>(
            this Eff<A> ma, Schedule<A> schedule, S state, Func<S, A, S> fold, Func<A, bool> pred)
