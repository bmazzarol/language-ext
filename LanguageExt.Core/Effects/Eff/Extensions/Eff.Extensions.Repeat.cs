...
namespace LanguageExt
{
    public static partial class EffExtensions
    {
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> Repeat<RT, A>(this Eff<RT, A> ma, Schedule<RT, A> schedule) where RT : struct
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> Repeat<RT, A>(this Eff<RT, A> ma, Schedule<A> schedule) where RT : struct
            => ScheduleEff<RT, A>.Repeat(ma, schedule);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<A> Repeat<A>(this Eff<A> ma, Schedule<A> schedule)
        ...
        public static Eff<RT, A> RepeatWhile<RT, A>(
            this Eff<RT, A> ma, Schedule<RT, A> schedule, Func<A, bool> predicate)
            where RT : struct
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RepeatWhile<RT, A>(this Eff<RT, A> ma, Schedule<A> schedule, Func<A, bool> predicate)
            where RT : struct
            => ScheduleEff<RT, A>.RepeatWhile(ma, schedule, predicate);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RepeatWhile<RT, A>(this Eff<RT, A> ma, Schedule schedule, Func<A, bool> predicate)
            where RT : struct
            => ScheduleEff<RT, A>.RepeatWhile(ma, schedule, predicate);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<A> RepeatWhile<A>(this Eff<A> ma, Schedule<A> schedule, Func<A, bool> predicate)
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RepeatUntil<RT, A>(this Eff<RT, A> ma, Schedule<RT, A> schedule,
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RepeatUntil<RT, A>(this Eff<RT, A> ma, Schedule<A> schedule, Func<A, bool> predicate)
            where RT : struct
            => ScheduleEff<RT, A>.RepeatUntil(ma, schedule, predicate);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RepeatUntil<RT, A>(this Eff<RT, A> ma, Schedule schedule, Func<A, bool> predicate)
            where RT : struct
            => ScheduleEff<RT, A>.RepeatUntil(ma, schedule, predicate);
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<A> RepeatUntil<A>(this Eff<A> ma, Schedule<A> schedule, Func<A, bool> predicate)
