...
namespace LanguageExt
{
    public static partial class Prelude
    {
        ...
        public static Eff<RT, S> fold<RT, S, A>(Schedule<RT, A> schedule, Eff<RT, A> ma, S state, Func<S, A, S> fold)
            where RT : struct
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> fold<RT, S, A>(Schedule<A> schedule, Eff<RT, A> ma, S state, Func<S, A, S> fold)
            where RT : struct
            => ScheduleEff<RT, A>.Fold(ma, schedule, state, fold);
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <returns>The result of the fold operation</returns>
        public static Eff<S> fold<S, A>(Schedule<A> schedule, Eff<A> ma, S state, Func<S, A, S> fold)
        ...
        public static Eff<RT, S> foldWhile<RT, S, A>(
            Schedule<RT, A> schedule, Eff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
            where RT : struct
        ...
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> foldWhile<RT, S, A>(
            Schedule<A> schedule, Eff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred) where RT : struct
            => ScheduleEff<RT, A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        /// <returns>The result of the fold operation</returns>
        public static Eff<RT, S> foldWhile<RT, S, A>(
            Schedule schedule, Eff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred) where RT : struct
            => ScheduleEff<RT, A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        public static Eff<S> foldWhile<S, A>(
            Schedule<A> schedule, Eff<A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
        ...
        /// <returns>The result of the fold operation</returns>
        public static Eff<S> foldWhile<S, A>(
            Schedule schedule, Eff<A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred)
            => ScheduleEff<A>.FoldWhile(ma, schedule, state, fold, pred);
        ...
        public static Eff<RT, S> foldUntil<RT, S, A>(
            Schedule<RT, A> schedule, Eff<RT, A> ma, S state, Func<S, A, S> fold, Func<A, bool> pred) where RT : struct
